      ...
      <div className="w-full max-w-sm">
        <div className="bg-white/60 backdrop-blur-xl p-8 rounded-2xl border border-white/30 shadow-lg text-center">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <input type="text" placeholder="Name" name="name" value={name} onChange={onChange} required className="w-full px-4 py-3 bg-white/70 rounded-lg border border-white/50 focus:outline-none focus:ring-2 focus:ring-brand-purple text-lg" />
              ...
              <input type="password" placeholder="Password" name="password" value={password} onChange={onChange} required minLength="6" className="w-full px-4 py-3 bg-white/70 rounded-lg border border-white/50 focus:outline-none focus:ring-2 focus:ring-brand-purple text-lg" />
            ...
            <p className="mt-6 text-gray-600">
              Already have an account? <Link to="/login" className="font-bold text-brand-purple hover:underline">Log In</Link>
            </p>
        </div>
      </div>
    </motion.div>
